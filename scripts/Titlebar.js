function Titlebar() {
	...
	tab.setOnSelectedListener(function(index) {
        ...
        for (var i = 0; i < items.length; i++) {
            items[i].setTextColor(R.color.text);
        }
        items[index].setTextColor(R.color.theme);
    });
    //default 0
	...
	var setting = Theme.createIconBtn("img/more.png", 24);
	...
	var menu = Theme.createIconBtn("img/drawer.png", 24);
...
function LogoArea(alignLeft) {
	...
	logo.setImageUri("img/cat_icon.png");
	this.addView(logo);
